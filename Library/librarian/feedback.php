	...
	<div class="scroll">
		<?php
			if(isset($_POST['submit'])){
				$sql="INSERT INTO `comment` VALUE('','Librarian','$_POST[comment]');";
				if(mysqli_query($db,$sql)){
					...
					while($row=mysqli_fetch_assoc($res)){
					    echo "<tr>";
					    if($row['username'] == 'Librarian') {
					        echo "<td><span style='color:green;'>"; echo $row['username']; echo "</span></td>";
					    }else  if($row['username'] == 'Admin') {
					        echo "<td><span style='color:red;'>"; echo $row['username']; echo "</span></td>";
					    }
					    else  {
