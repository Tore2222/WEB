...
<body>
	...
	if(isset($_POST['submit'])){
		...
		if($count == 0){
		mysqli_query($db,"INSERT INTO `librarian`(id,firstname,lastname,username,password,phonenumber,email,pic) VALUES('','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[phonenumber]','$_POST[email]','user-icon-vector-png-6.png');");
