...
<body style="background-color: #6db6b9e6;">
	...
	<?php 
		$sql = "SELECT * FROM librarian WHERE username = '$_SESSION[login_librarian]'";
	...
	<?php 
		if (isset($_POST['submit'])) {
			...
			$sql1="UPDATE librarian SET pic='$pic',firstname='$firstname',lastname = '$lastname',username='$username',email='$email',phonenumber='$phonenumber' WHERE username='".$_SESSION['login_librarian']."';";
