...
<body style="background-color: #6db6b9e6;">
	...
	<?php 
		if (isset($_POST['submit'])) {
			...
			$sql1="UPDATE admin SET pic='$pic',firstname='$firstname',lastname = '$lastname',username='$username',email='$email',phonenumber='$phonenumber' WHERE username='".$_SESSION['login_admin']."';";
