	...
	<div class="srch">
 	...
 	<?php
 		if (isset($_POST['submit'])) {
 			$q=mysqli_query($db,"SELECT firstname ,lastname,username,email,phonenumber FROM `member` where username like '%$_POST[search]%'");
 			...
 			$res = mysqli_query($db,"SELECT firstname ,lastname,username,email,phonenumber FROM `member`;");
