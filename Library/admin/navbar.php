...
<?php 
	if(isset($_SESSION['login_admin'])){
		...
		$r=mysqli_query($db,"SELECT COUNT(status) as total from message where status='no' and username = '$_SESSION[login_admin]' and sender = 'member' ;");
					...
					if (isset($_SESSION['login_admin'])){
						?>
							<ul class="nav navbar-nav">
								...
								<li><a href="member-information.php">MEMBER-INFOR</a></li>
								<li><a href="librarian-information.php">LIBRARIAN-INFOR</a></li>
