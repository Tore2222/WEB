...
<div class="container">
	<div class="srch">
 	...
 	<h2>List of Librarian</h2>
 	<?php
 		if (isset($_POST['submit'])) {
 			$q=mysqli_query($db,"SELECT firstname ,lastname,username,email,phonenumber FROM `librarian` where username like '%$_POST[search]%'");
 			...
 			$res = mysqli_query($db,"SELECT firstname ,lastname,username,email,phonenumber FROM `librarian`;");
